 <nav class="flex-row p-0 admin-header navbar navbar-default col-lg-12 col-12 fixed-top d-flex">
     ...
     <div class="text-left navbar-brand-wrapper">
         <a class="navbar-brand brand-logo" href="{{ route('dashboard') }}"><img src="{{ asset('asset/images/logo-dark.png') }}"
                 alt=""></a>
         <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard') }}"><img
                 src="{{ asset('asset/images/logo-icon-dark.png') }}" alt=""></a>
     </div>
     <!-- Top bar left -->
     ...
     <ul class="ml-auto nav navbar-nav">
         ...
         <li class="nav-item dropdown mr-30">
             <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                 ...
                 <img src="{{ asset('asset/images/profile-avatar.jpg') }}" alt="avatar">
             </a>
